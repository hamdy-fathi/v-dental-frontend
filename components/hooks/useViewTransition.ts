...
type TransitionCallback = (() => void) | undefined;
...
export const useViewTransition = () => {
  ...
  function slideInOut(href: string, onRouteChange?: TransitionCallback) {
  ...
  const navigateWithTransition = (href: string, onRouteChange?: TransitionCallback) => {
